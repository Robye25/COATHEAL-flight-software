...
# Rev C config defaults (phase.sample_floor_c=5, heater.max_sample_temp_c=80
# since the owner rule of 2026-09-15, phase.uniformity_tolerance_c=2,
# transition.pre_float_mbar=150).
SAMPLE_FLOOR_C = 5.0
OVERTEMP_CUTOFF_C = 80.0
